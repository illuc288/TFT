...
\include{source/manifolds_bordisms}
\include{source/cobordism_groups}

\part{Topological field theories}
\include{source/preamble_tft}

%category theory chapter
\include{source/category_theory}
\include{source/category_theory_extra}
\include{source/monoidal_category}
\include{source/monoidal_category_outlook}
\include{source/more_category}
\include{source/more_category_outlook}

%cobordism category chapter
\include{source/cobordism_category}
\include{source/cobordism_category_outlook}
\include{source/dualisability}
\include{source/dualisability_outlook}

% classification of tfts chapter
\include{source/tft_classification}
\include{source/tft_classification_outlook}
...
\newpage
\input{source/exercises} % note - this is just a working interjection of the first sheet in these lecture notes (later on it might be nice to redistribute them to appear right after the concepts you need to solve them have been introduced) /Jacob
