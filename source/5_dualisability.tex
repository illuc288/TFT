...
\begin{defn}
    ...
    \begin{itemize}
        ...
        \item morphisms: $\Hom_{\Bordnor} (M,N) = $ ``orientation preserving diffeomorphism classes of
         oriented bordisms'' i.e. a bordism $(\Sigma,p,\theta_0,\theta_1)$ where $\Sigma$ has an orientation and the
         diffeomorphism $\de\Sigma \cong \bbar{M} \amalg N$ is an orientation preserving one
    \end{itemize}
\end{defn}
